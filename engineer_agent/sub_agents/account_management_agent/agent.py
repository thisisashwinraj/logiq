...
from .config import ACCOUNT_MANAGEMENT_AGENT_MODEL
from .config import (
    ACCOUNT_MANAGEMENT_AGENT_MAX_TOKENS, 
    ACCOUNT_MANAGEMENT_AGENT_TEMPERATURE
)
from .prompts import (
...
from .tools import (
    add_specializations, 
    remove_specializations, 
    add_skills, 
    remove_skills, 
    update_address, 
    get_district_from_zip
)
...
account_management_agent = Agent(
    ...
    model=ACCOUNT_MANAGEMENT_AGENT_MODEL,
    description=ACCOUNT_MANAGEMENT_AGENT_DESCRIPTION,
    instruction=ACCOUNT_MANAGEMENT_AGENT_INSTRUCTION,
    include_contents="default",
    generate_content_config=types.GenerateContentConfig(
        temperature=ACCOUNT_MANAGEMENT_AGENT_TEMPERATURE,
        max_output_tokens=ACCOUNT_MANAGEMENT_AGENT_MAX_TOKENS,
    ),
    tools=[
        add_specializations,
        remove_specializations,
