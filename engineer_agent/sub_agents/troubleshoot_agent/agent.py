...
from .config import TROUBLESHOOT_AGENT_MODEL
from .config import (
    TROUBLESHOOT_AGENT_MAX_TOKENS, 
    TROUBLESHOOT_AGENT_TEMPERATURE
)
from .prompts import (
    TROUBLESHOOT_AGENT_DESCRIPTION, 
    TROUBLESHOOT_AGENT_INSTRUCTION
)
from .tools import get_troubleshooting_help
...
TROUBLESHOOT_GUIDE_FILE_SEARCH_STORE = os.getenv(
    "TROUBLESHOOT_GUIDE_FILE_SEARCH_STORE_NAME"
)
...
troubleshoot_agent = Agent(
    ...
    model=TROUBLESHOOT_AGENT_MODEL,
    description=TROUBLESHOOT_AGENT_DESCRIPTION,
    instruction=TROUBLESHOOT_AGENT_INSTRUCTION,
    include_contents="default",
    generate_content_config=types.GenerateContentConfig(
        temperature=TROUBLESHOOT_AGENT_TEMPERATURE,
        max_output_tokens=TROUBLESHOOT_AGENT_MAX_TOKENS,
    ),
    tools=[
