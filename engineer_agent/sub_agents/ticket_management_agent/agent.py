...
from .config import MODEL_TICKET_MANAGEMENT_AGENT
from .config import MODEL_MAX_TOKENS, MODEL_TEMPERATURE
from .prompts import (
    TICKET_MANAGEMENT_AGENT_DESCRIPTION, 
    TICKET_MANAGEMENT_AGENT_INSTRUCTION
)

from .tools.active_tickets import (
    list_active_tickets, 
    get_ticket_details, 
    add_new_activity, 
    report_unsafe_working_condition
)
from .tools.resolved_tickets import (
    list_resolved_tickets, 
...
ticket_management_agent = Agent(
    ...
    model=MODEL_TICKET_MANAGEMENT_AGENT,
    description=TICKET_MANAGEMENT_AGENT_DESCRIPTION,
    instruction=TICKET_MANAGEMENT_AGENT_INSTRUCTION,
